# -*- coding: utf-8 -*-
"""Object detection using tiny yolo

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10s63N5o5wBqeLmy01X_e6W8tZKr93zX1
"""
...
model_path = os.path.join(execution_path, "/content/models/tiny-yolov3 (1).pt")
if not os.path.exists(model_path):
    ...
    # Path to input video
    input_video_path = os.path.join(execution_path, "/content/VID-20241120-WA0003.mp4")
